"use strict";
console.log("GAMEJS BUILD: 2025-12-19-REFACTOR-PHASE3");
...
// NOTE: TUNE mode moved to ui/tuneMode.js
  ...
  if (window.UI_MODE === "CITY_CLEAN") {
    ...
    if (typeof createBottomUI === "function") {
      ...
      if (typeof initTuneMode === 'function') {
        initTuneMode(this, cityBg, HERO_OFFSET);
      }
      if (typeof applyTuneSettings === 'function') {
        applyTuneSettings(this, cityBg, HERO_OFFSET);
      }
